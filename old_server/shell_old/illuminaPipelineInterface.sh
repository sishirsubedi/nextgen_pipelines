...
then
  ...
  echo $file
	...
	bash /var/pipelines_"$environment"/shell/exomeInterface.sh -p $fastq1 -q $fastq2 -o /home/environments/$environment/"$instrument"Analysis/$runName/$sampleName/variantCaller
