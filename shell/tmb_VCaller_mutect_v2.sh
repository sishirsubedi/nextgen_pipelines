...
/opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/tmb_parseMutect_v2.py  "$SAMPLE"  "$OUT_DIR"  "$ENV" $DEPTH $NALF $TALF

# /opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/tmb_filterCreDesign.py  ${OUT_DIR}  ${SAMPLE}.mutect.${DEPTH}_${NALF}_${TALF}  $ENV
