...
/opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/parseMutect.py  "$SAMPLE"  "$OUT_DIR"  "$ENV"

/opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/filterCreDesign.py  ${OUT_DIR}  ${SAMPLE}.mutect.parafilter  $ENV
