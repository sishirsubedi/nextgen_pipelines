...
cat ${OUT_DIR}active_chromosomes.txt | /opt/parallel/bin/parallel  --jobs 10 " java -jar /opt/GATK4/GenomeAnalysisTK.jar \
                                    -T MuTect2 \
                                    -R $REF \
...
/opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/parseMutect.py  "$SAMPLE"  "$OUT_DIR"  "$ENV" $DEPTH $NALF $TALF

# /opt/python3/bin/python3 /home/pipelines/ngs_${ENV}/python/filterCreDesign.py  ${OUT_DIR}  ${SAMPLE}.mutect.${DEPTH}_${NALF}_${TALF}  $ENV
